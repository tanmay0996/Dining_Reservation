...
const Hotels = require("./db/Hotels.js");
const Users = require("./db/Users.js");
const Bookings = require("./db/Bookings.js");
const Managers = require("./db/Manager.js");
...
app.post("/payment", async (req, res) => {
  try {
    ...
    jwt.verify(token, secretKey, {}, async (err, info) => {
      ...
      const { hotelname, hotel, tableSelected, slotSelected, curruseremail } =
        req.body;
      ...
      const lineItems = [
        {
          price_data: {
            ...
            product_data: {
              name: hotelname,
              description: "Dining reservation at " + hotelname,
              metadata: {
                table: tableSelected,
                slot: slotSelected,
              },
